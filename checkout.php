        ...
        <div id="menu" style="margin-top:10px;">
                    <ul>
                        ...
                        <li>
                            ...
                            <ul class="sub-menu">
                                <li><a href="thucdon_2.php?id_sanpham=1">Dragon Ball Z</a></li>
                                <li><a href="thucdon_2.php?id_sanpham=2">GAM ESPORTS</a></li>
                ...
                if(isset($_SESSION['submit'])) {
                    $user_admin = $_SESSION['submit'];
                            if($user_admin == 'Admin_Chu') {
                                ...
                                echo '<a style="color:black;" href="">' . $_SESSION['submit'] . '</a>
                                <div class="logout">
                                <a href="changepassword.php"><i class="fas fa-exchange-alt"></i>Đổi mật khẩu</a> <br>                           
                                <a href="logout.php"><i class="fas fa-sign-out-alt"></i>Đăng xuất</a>
                                </div>';
                                                        }
                } 
