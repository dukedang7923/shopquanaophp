...
#banner1 {
    width: 100%;
    background-image :url("/Web/images/banner dragonball.jpg");
...
#banner2 {
    width: 100%;
    background-image :url("/Web/images/banner GAM.jpg");
    background-size:cover;
    height: 1000px;/*chỉnh size banner*/
    margin-top:40px;
    display: flex;
    padding:0px 133px;
    position:relative;
...
#banner2  .box-left h2 {/* chỉnh chữ GAM ESPORTS*/
...
#banner2 .box-left button {/*nút buttom mua ngay*/
    font-size:30px;/*chỉnh size chữ*/
    width: 250px;/*chỉnh size dài bóng đen*/
    height: 60px;/*chỉnh size rộng bóng đen*/
    margin-top:300px;/*chỉnh vị trí buttom lên xuống*/
    margin-left:1200px;/*chỉnh vị trí buttom trái phải*/
    background:#1d1a1a;
    border:none;
    outline:none;
    color:#fff;
...
#banner3 .box-left button {/*nút buttom mua ngay*/
    ...
    width: 170px;/*chỉnh size dài bóng đen*/
    height: 45px;/*chỉnh size rộng bóng đen*/
    margin-top:500px;/*chỉnh vị trí buttom lên xuống*/
    margin-left:700px;/*chỉnh vị trí buttom trái phải*/
    background:#1d1a1a;
    border:none;
    outline:none;
    color:#fff;
